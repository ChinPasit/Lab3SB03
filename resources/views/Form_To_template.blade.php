...
<head>
  <meta charset="UTF-8">
  <title>LAB3SB03 : Framework Laravel</title>
...
<div class="wrapper">	
	<div class="content clearfix">
		...
		<div class="col one">
			<img src="https://scontent.fbkk22-1.fna.fbcdn.net/v/t1.0-9/17634314_1477067405691132_1414776599317144920_n.jpg?_nc_cat=101&_nc_ht=scontent.fbkk22-1.fna&oh=6abae0a5fdd1c1a0061e720a8b218722&oe=5CDD7DEB" alt="591 Industries" width="740" height="729" id="logo-v" />
		</div>
			<div class="col two">
				<h4>CHIN (tm) <br /> <b>H</b>euristically <b>E</b>ncrypted <b>R</b>eal-Time <b>O</b>perating <b>S</b>ystem (Laravel)</h4>
				<p>----------------------------------------</p>
		...
		<nav class="site clear">
			<ul>
				<li><a href="#" title="">CHINJUNG</a></li>
				<li><a href="#" title="">Contact Us</a></li>
			</ul>
		</nav>
				
		<p>System Administrator Integrated Message System (SAIMS)</p>
		<p>System Administrator PASIT THANADAMKERNG 5910110216</p>

		<p class="clear"><br /></p>

		<p>Welcome Email Service - Send To Email</p><br />
		
			<form action = "/Send_mail" method="POST">
				<label>Name >></label><input name = "Name"type="text" /><br />
				<label>Email >></label><input name = "Email"type="text" /><br />
				<label>Subject >></label><input name = "Subjects"type="text" /><br />
				<label>Message >></label><input name = "Messager" type ="text" ><br /><br /><br />
				<button class="btn btn3" type="submit" value="Submit">send email</button><br />
			</form>
		</div>
	</div>
